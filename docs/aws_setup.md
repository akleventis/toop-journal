...
AWS credentials are configured through the UI in the **<a href="/renderer/src/More.tsx">More.tsx</a>** component. The configuration is stored in the user data directory (`config.json`).
